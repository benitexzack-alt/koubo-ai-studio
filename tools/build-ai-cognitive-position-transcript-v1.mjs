...
const pages = [
  ...
  ['真正改变的是，过去一个人很难接触、', 'The real change is that knowledge once hard for one person to access', ['真正改变', '接触']],
  ['读完、比较的知识和案例，', 'read, and compare', ['读完', '比较']],
  ...
  ['很多所谓“最高层的赚钱方法”，', 'Many so-called top-tier money methods', ['赚钱方法']],
  ['未必是什么神秘答案。', 'are not necessarily mysterious answers.', ['不是神秘答案']],
  ...
  ['我们的理解和真实世界，', 'Between our understanding and reality,', ['理解', '真实世界']],
  ['究竟差在哪里。', 'where exactly is the gap?', ['差在哪里']],
  ...
  ['普通人最值得站住的，是它通往真实需求', 'What ordinary people should hold is the path to real needs', ['普通人', '真实需求']],
  ['和真实结果的最后一段。', 'and the final mile to real outcomes.', ['真实结果']],
