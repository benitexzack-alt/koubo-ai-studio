...
const pageSpecs = [
  ...
  {end: '能站在哪儿。', startMs: 20220, endMs: 23020, zh: '听完你再判断，自己能站在哪儿。', en: 'Then decide where you can stand in it.', highlights: ['站在哪儿']},
  {end: 'Token到底是什么？', startMs: 23360, endMs: 24820, zh: 'Token 到底是什么？', en: 'What exactly is a token?', highlights: ['Token']},
  ...
  {end: '回复一段话，', startMs: 31820, endMs: 33300, zh: '你让豆包回复一段话。', en: 'You ask Doubao to reply with a paragraph.', highlights: ['豆包']},
  {end: '写一份文案，', startMs: 33440, endMs: 35200, zh: 'DeepSeek 写一份文案。', en: 'DeepSeek writes a piece of copy.', highlights: ['DeepSeek']},
  ...
  {end: '有用的结果。', startMs: 113060, endMs: 114520, zh: '而是一个有用的结果。', en: 'What they buy is a useful result.', highlights: ['有用的结果']},
  ...
  {end: '研发的陇小郎，', startMs: 149300, endMs: 153700, zh: '下游，就在前几天，咱们甘肃省中医院研发的“陇小郎”。', en: 'Downstream, Gansu Provincial Hospital of Traditional Chinese Medicine recently developed Longxiaolang.', highlights: ['下游', '陇小郎']},
  {end: 'AI结合，', zh: '把中医舌诊经验和 AI 结合。', en: 'It combines AI with experience in traditional Chinese tongue diagnosis.', highlights: ['AI 结合']},
  {end: '首轮的成果转化。', startMs: 156420, endMs: 159500, zh: '已经完成了独家授权和首轮的成果转化。', en: 'It has completed exclusive authorization and its first result transfer.', highlights: ['独家授权', '首轮成果转化']},
...
for (const spec of pageSpecs) {
  ...
  bilingual.push({
    startMs: spec.startMs ?? pageSpans[0].startMs,
    endMs: spec.endMs ?? pageSpans[pageSpans.length - 1].endMs,
    zh: spec.zh,
    en: spec.en,
