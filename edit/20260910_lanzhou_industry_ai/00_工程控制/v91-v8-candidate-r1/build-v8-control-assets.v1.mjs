...
const paper = ({id, beatId, start, duration, clip, title: layerTitle, detail, role, sound}) => {
  ...
  return {
    ...
    postshootBinding: {
      ...
      timingPolicy: 'actual-spoken-term-bound-conservative',
    },
    _sfxSource: `${sfxRoot}/${sound}.wav`,
    _sfxRenderSource: `sfx/${sound}.wav`,
  };
...
const layers = [
  ...
  info({id: 'v91-004-b04-experience', beatId: 'B04', start: 24.5, end: 40, title: '别把原来的经验扔掉', detail: '销售、开店、行业经验，都可以变成对客户的了解', items: ['销售', '开过店', '客户的了解'], component: 'process', family: 'experience-process', tone: 'green', role: 'list', sound: 'v3-list-tick-a'}),
  paper({id: 'v91-005-p01-b04', beatId: 'B04', start: 40, duration: 7.292, clip: 'P01', title: '经验留下来', detail: '销售和开店经验，汇到对客户的了解', role: 'media', sound: 'v3-media-whoosh-a'}),
  info({id: 'v91-006-b05-generic-copy', beatId: 'B05', start: 47.292, end: 52.1, title: '“品质好、服务好”还不够', detail: '客户看完，仍然不知道为什么选你', component: 'definition', family: 'generic-vs-specific', tone: 'red', role: 'comparison', sound: 'v2-section-sweep'}),
  ...
  info({id: 'v91-008-b07-organize', beatId: 'B07', start: 66, end: 85.6, title: '把回答整理成能拍的内容', detail: '收集 → AI归类理顺 → 改成文稿 → 老板核对', items: ['收集', '归类', '改稿', '核对'], component: 'process', family: 'four-step-process', tone: 'cyan', role: 'keyword', sound: 'v3-soft-card-pop-a'}),
  paper({id: 'v91-009-p02-b07', beatId: 'B07', start: 85.6, duration: 8, clip: 'P02', title: '老板核对后再讲出去', detail: 'AI承担整理和制作，生意的底子还是老板做过的事', role: 'media', sound: 'v2-keyword-select'}),
  info({id: 'v91-010-b08-findable', beatId: 'B08', start: 93.6, end: 97.9, title: '让没进过店的人也能看到', detail: '把原来只在店里讲的经验，变成可见的介绍', component: 'definition', family: 'visibility-bridge', tone: 'green', role: 'line', sound: 'v3-line-connect-a'}),
  ...
  info({id: 'v91-012-b10-service-chance', beatId: 'B10', start: 114, end: 136.7, title: '把经验讲清楚，是一种服务机会', detail: '帮老板持续做成内容，但内容不能代替真实产品和服务', component: 'comparison', family: 'service-boundary', tone: 'amber', role: 'evidence', sound: 'v2-evidence-shutter'}),
  paper({id: 'v91-013-p03-b10', beatId: 'B10', start: 136.7, duration: 6.584, clip: 'P03', title: '内容接不住空生意', detail: '没有能交给客户的产品和服务，只发内容也接不住', role: 'media', sound: 'v3-media-whoosh-b'}),
  info({id: 'v91-014-b11-remote-gap', beatId: 'B11', start: 143.284, end: 147.7, title: '先能听懂行业问题', detail: '再把约定的工作做好，才有资格介绍服务', component: 'definition', family: 'capability-gate', tone: 'cyan', role: 'number', sound: 'v2-number-affirmation'}),
  paper({id: 'v91-015-p04-b11', beatId: 'B11', start: 147.7, duration: 6.584, clip: 'P04', title: '向外地介绍服务', detail: '介绍给同样需要整理客户问题、制作产品内容的同行', role: 'media', sound: 'v1-section-air'}),
  info({id: 'v91-016-b12-remote-real', beatId: 'B12', start: 154.284, end: 165, title: '远程业务早就有了', detail: 'AI增加的是整理和制作能力；信任还得靠作品和服务', component: 'comparison', family: 'old-new-boundary', tone: 'white', role: 'list', sound: 'v3-list-tick-b'}),
  ...
  info({id: 'v91-019-b15-cost', beatId: 'B15', start: 199, end: 217.7, title: '这不是零成本创业', detail: '课程、会员、调用、做图、做视频都要花钱，不适合还得继续改', items: ['学习费用', '工具调用', '制作与返工'], component: 'evidence', family: 'cost-ledger', tone: 'red', role: 'evidence', sound: 'v1-camera-shutter'}),
  paper({id: 'v91-020-p05-b15', beatId: 'B15', start: 217.7, duration: 6.584, clip: 'P05', title: '钱花少一些，多试几次', detail: '少花钱不等于零成本，只是多一点试错空间', role: 'media', sound: 'v2-ui-click'}),
  info({id: 'v91-021-b17-scope', beatId: 'B17', start: 224.284, end: 244.7, title: '收服务费之前，先把边界讲清楚', detail: '做哪些工作、谁配合、交什么东西，客户用不上还要继续查问题', items: ['工作范围', '双方配合', '交付物'], component: 'checklist', family: 'scope-checklist', tone: 'cyan', role: 'chapter', sound: 'remotion-page-turn'}),
  paper({id: 'v91-022-p06-b17', beatId: 'B17', start: 244.7, duration: 6.584, clip: 'P06', title: '服务范围、协作和交付', detail: '不用通用方案敷衍真实问题', role: 'media', sound: 'remotion-ui-switch'}),
  info({id: 'v91-023-b18-more-work', beatId: 'B18', start: 251.284, end: 262, title: '只靠生成几段文字、几张图片，会越来越难', detail: '你得比老板自己试，多承担他没时间做、不会检查、无法持续的工作', component: 'comparison', family: 'value-gap', tone: 'amber', role: 'line', sound: 'v3-evidence-paper-a'}),
...
const visualPlan = {
  ...
  editPolicy:
    '完整保留真人口播；六条纸艺成品仅在V9.1实录术语绑定时点全屏切入，全部静音，始终使用R01录音为唯一口播音轨。',
  safeAreas: {
