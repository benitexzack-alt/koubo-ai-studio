...
ensure(path.isAbsolute(descriptor) && descriptor.startsWith(`${root}/edit/20260906_lanzhou_ai_services/00_工程控制/candidate-preview-r2/runtime/runs/`)
...
if (composition.id !== 'LanzhouServicesV91CandidateR2' || composition.width !== 1920 || composition.height !== 1080
